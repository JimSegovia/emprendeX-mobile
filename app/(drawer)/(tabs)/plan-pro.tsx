      ...
      <ScrollView className="flex-1 bg-[#f8fafc]" contentContainerStyle={{ padding: 20, paddingBottom: 60 }}>
        <View className="items-center mb-8 pt-4">
          ...
          <Text className="text-slate-500 text-center text-sm px-4">
            Actualiza a Pro y accede a herramientas avanzadas para crecer m+�s.
          </Text>
        </View>
        ...
        <View className="flex-row justify-between mb-8 h-[440px]">
          ...
          <View className="w-[48%] bg-white rounded-3xl border border-slate-200 p-4 shadow-sm flex-col justify-between">
            <View>
              ...
              <View className="space-y-3">
                ...
                <View className="flex-row items-center"><Check size={14} color={palette.primary} /><Text className="text-[11px] text-slate-700 ml-2">Inventario b+�sico</Text></View>
                <View className="flex-row items-center"><Check size={14} color={palette.primary} /><Text className="text-[11px] text-slate-700 ml-2">Reportes b+�sicos</Text></View>
              </View>
            </View>
          ...
          <View className="w-[48%] bg-white rounded-3xl border-2  p-4 shadow-md flex-col justify-between relative overflow-hidden" style={{ borderColor: palette.primary }}>
            ...
            <View className="mt-4">
              ...
              <Text className="text-[10px] font-semibold text-slate-800 mb-3 text-center">Todo lo del plan Gratis, m+�s:</Text>
              <View className="space-y-3">
                ...
                <View className="flex-row items-center"><Check size={14} color="#10b981" /><Text className="text-[11px] font-medium text-slate-800 ml-2">An+�lisis e IA</Text></View>
        ...
        <View className=" rounded-2xl p-4 flex-row items-center mb-6" style={{ backgroundColor: palette.primarySoft }}>
          ...
          <View className="flex-1">
            ...
            <Text className="text-slate-500 text-xs">Tu plan se renueva autom+�ticamente cada mes.</Text>
          </View>
        </View>
        ...
        <View className="space-y-4 mb-10 px-2">
          <View className="flex-row items-start">
            ...
            <View>
              ...
              <Text className="text-xs text-slate-500 mt-1">Calendario, Reportes, IA y m+�s.</Text>
            </View>
          </View>
          <View className="flex-row items-start">
    ...
    <Animated.View className="flex-1 bg-[#f5f5f5]" entering={SlideInRight} exiting={SlideOutLeft} key="mercadopago">
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 16 }}>
        ...
        <View className="flex-row items-center justify-center mt-6 mb-10">
          ...
          <Text className="text-xs text-slate-400 ml-2">Tus datos est+�n protegidos con encriptaci+�n SSL</Text>
        </View>
          </>
        )}
      </ScrollView>
          ...
          <View className="space-y-4">
            ...
            <View className="flex-row items-center justify-between">
              <View className="flex-row items-center">
                ...
                <Text className="font-medium text-slate-700">An+�lisis e IA</Text>
              </View>
              <View className="h-5 w-5 bg-emerald-100 rounded-full items-center justify-center"><Check size={12} color="#10b981" /></View>
            </View>
