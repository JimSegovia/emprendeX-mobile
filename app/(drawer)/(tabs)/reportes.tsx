...
export default function ReportesScreen() {
  ...
  return (
    <Animated.View className="flex-1 bg-white" entering={screenEntering}>
      ...
      >
        <Animated.View
          className="items-center rounded-[32px] border border-amber-100 bg-amber-50 px-6 py-8"
        ...
        <Animated.View
          className="mt-6 rounded-[28px] border border-slate-100 bg-white p-5 shadow-sm shadow-slate-100"
          ...
          <View className="mb-4 flex-row items-center justify-between">
            <View>
              ...
              <Text className="mt-1 text-sm text-slate-500">
                Metricas y comparativos para decisiones rapidas.
              </Text>
            </View>
